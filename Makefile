...
CFLAGS += ${IGNORED_FLAGS} ${DEBUGGING_FLAGS} ${OPTIMIZATION_FLAGS} -lpthread
 
TESTLIBS ?= -lcheck -lm -lrt
LDFLAGS ?= -s -lX11 -lXtst -lXi -lxcb -lxcb-xtest -lxcb-xinput -lxcb-ewmh -lxcb-icccm -lxcb-randr -lX11-xcb 
...
testMem: Tests/MemTest/TestMemoryLeaks.c ${LIBSRCS} ${LIBHEADERS}
