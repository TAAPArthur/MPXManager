...
void addDefaultXMouseControlBindings(uint32_t mask) {
    Binding bindings[] = {
        ...
        BINDING(mask, XK_l, SCROLL_LEFT_MASK),
        BINDING(mask, XK_j, SCROLL_DOWN_MASK),
        BINDING(mask, XK_h, SCROLL_RIGHT_MASK),
        BINDING(mask | ShiftMask, XK_k, MOVE_UP_MASK),
        BINDING(mask | ShiftMask, XK_l, MOVE_LEFT_MASK),
        BINDING(mask | ShiftMask, XK_j, MOVE_DOWN_MASK),
        BINDING(mask | ShiftMask, XK_h, MOVE_RIGHT_MASK),
