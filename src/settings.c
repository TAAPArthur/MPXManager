...
#define _startCycleWindowChainBinding CHAIN_GRAB(XCB_INPUT_XI_EVENT_MASK_KEY_PRESS | XCB_INPUT_XI_EVENT_MASK_KEY_RELEASE, \
        ...
        {WILDCARD_MODIFIER, XK_Alt_L, BIND(endCycleWindows), .endChain=1,.noGrab = 1,  .mask = XCB_INPUT_XI_EVENT_MASK_KEY_RELEASE},\
        {WILDCARD_MODIFIER, 0, .noGrab = 1,   .passThrough = NO_PASSTHROUGH})
...
static Binding DEFAULT_BINDINGS[] = {
...

    {
        ...
        {WILDCARD_MODIFIER, 0, BIND(stopMouseOperation), .mask = -1, .noGrab = 1})),
    ...
    {Mod1Mask, XK_Tab, _startCycleWindowChainBinding},
    {Mod1Mask | ShiftMask, XK_Tab, _startCycleWindowChainBinding},
